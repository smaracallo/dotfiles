...
def harden(writeout_file):
    ...
    for ip_address in ip_addresses:
        ...
        os.system('scp /home/ubuntu/.ssh/id_rsa.pub root@{ip_address}:/etc/ssh/remoteuser/authorized_keys'.format(ip_address=ip_address))
        os.system('sh -c \'echo "remoteuser:swordfish" > /home/ubuntu/dotfiles/setup/.credentials\'')
        os.system('scp /home/ubuntu/dotfiles/setup/.credentials root@{ip_address}:/home/remoteuser/'.format(ip_address=ip_address))
        os.system('ssh -o "StrictHostKeyChecking no" root@{ip_address} \'bash -s\' < procedures/remote1.sh'.format(ip_address=ip_address))
    os.system('rm /home/ubuntu/dotfiles/setup/.credentials')
    return ip_addresses
