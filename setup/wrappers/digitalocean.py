...
def builder():
    ...
    pat_path = '/home/ubuntu/.pat/.digitalocean' # FIXME Parameter hard-coded to expedite testing.
    ...
    # vm_count = int(input('vm_count: ')) # FIXME Parameter hard-coded to expedite testing.
    vm_count = 2                          # FIXME Parameter hard-coded to expedite testing.
    if vm_count < 1:
...
def get_host(droplet_id, writeout_file):
    pa_token = open('/home/ubuntu/.pat/.digitalocean').read() # FIXME redundant
